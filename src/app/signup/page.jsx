        ...
        <section className='flex container mx-auto items-center my-32'>
            ...
            <div className='w-1/2 px-20 border-2 rounded-md border-white py-10'>
                <form onSubmit={handleSignup}>
                    ...
                    <div>
                        <button type='submit' className='w-full bg-transparent btn btn-primary btn-outline font-semibold transition-all duration-300 mt-5 rounded-lg text-xl'>Sign Up</button>
                    </div>
                </form>
            <div>
                    ...
                    <div className='text-center mt-4'>
                        <Link href={'/login'} className='text-[#444] text-lg font-normal text-center'>Already have an account? <span className='text-orange font-medium'>Login</span></Link>
                    </div>
                </div>
            </div>
        </section>
